...
public class GestorReportes {
    ...
    public boolean reporteCarrera(Carrera carrera, ArrayList<RegistroCarrera> registroCarrera){
    ...
    public boolean reporteFechas(Date fechaInicial, Date fechaFinal, ArrayList<Carrera> carreras, ArrayList<RegistroCarrera> registroCarrera){
       for(int i = 0; i < carreras.size(); i++){
           if((carreras.get(i).getFecha()).after(fechaInicial) && (carreras.get(i).getFecha()).before(fechaFinal)){
               this.reporteCarrera(carreras.get(i), registroCarrera);
           } 
       }
       return true;
    }
