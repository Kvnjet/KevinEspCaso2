...
public class GestorCarreras {    
    public static boolean simularRecorrido(Recorrido simulacion, ArrayList<RegistroCarrera> registroCarrreras){
       Date fecha = new Date();
    ...
    public static boolean simularCircuito(Circuito simulacion, ArrayList<RegistroCarrera> registroCarrreras){
       Date fecha = new Date();
       simulacion.setFecha(fecha);
       int participantes = simulacion.getCiclistas().size();
       if(participantes == 0){
